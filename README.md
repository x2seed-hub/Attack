...
spawn(function()
    ...
    spawn(function()
		pcall(function()
			while wait() do
				if _G.Farmfast and World1 then
					if game.Players.LocalPlayer.Data.Level.Value >= 70 then
				    	_G.AutoFarm = true
				Useskill = false
...
Set:Dropdown("Select Weapon",WeaponList,{"Melee"},function(t)
_G.SelectWeapon = t
end)
...
Set:Dropdown("Attack Modes",AttackType,{"Normal"},function(F)
    _G.FastAttackDelay = F
    _G.FastAttack = F
end)
spawn(function()
    while wait(.1) do
...
Set:Slider("Lock FPS",true,0,240,120,function(value)
		FPSLimit = value
		setfpscap(FPSLimit)
end)

Set:Button('Kaitun Cap',function()
loadstring(game:HttpGet("https://raw.githubusercontent.com/hajibeza/File/main/Kaitun_Cap.lua"))()
end)

Set:Button('Remove Kaitun Cap',function()
game:GetService("TeleportService"):Teleport(game.PlaceId, game:GetService("Players").localPlayer)
end)

Set:Button('Remove Lava',function()
...
local Auto = Win:CraftTab('Farm')

local Farm = Auto:CraftPage('Auto Farm',1)
...
Farm:Label("Enchancement Colour")
...
if World2 then
    Farm:Button("Teleport To Lab", function()
...
Farm:Dropdown("Select Chip", Raidslist, function(value)
    _G.SelectChip = value
end)

Farm:Button("Buy Selected Chip", function()
    game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("RaidsNpc","Select",_G.SelectChip)
end)

Farm:Toggle("Auto Select Raid", false, function(value)
...
Farm:Toggle("Auto Buy Chip", false, function(value)
...
Farm:Toggle("Auto Start Raid", false, function(value)
...
Farm:Toggle("Kill Aura", false, function(value)
    _G.Kill_Aura = value
end)
spawn(function()
    pcall(function() 
...
Farm:Toggle("Auto Next Island", false, function(value)
...
Farm:Toggle("Auto Awanken Fruit", false, function(value)
...
Farm:Label("Advanced Raid")

Farm:Button("Buy Law Raid Chip", function()
    local args = {
        [1] = "BlackbeardReward",
        [2] = "Microchip",
        [3] = "2"
...
Farm:Button("Start Law Raid", function()
    fireclickdetector(game:GetService("Workspace").Map.CircleIsland.RaidSummon.Button.Main.ClickDetector)
end)

Farm:Toggle("Auto Law Raid", false, function(value)
...
Farm:Toggle("Auto Phoenix Raid", false, function(value)
...
Farm:Button("Shop Devil Fruit",function()
    local args = {
        [1] = "GetFruits"
    }
    game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer(unpack(args))
...
Farm:Button("Random Fruit",function()
    local args = {
        [1] = "Cousin",
        [2] = "Buy"
    }
...
Farm:Toggle("Bring All Fruits", false, function(value)
...
Farm:Toggle("Store All Fruits", false, function(value)
...
Farm:Toggle("ESP All Fruits", false, function(value)
...
Farm:Toggle("ESP Real Fruits", false, function(value)
...
local Farm = Auto:CraftPage('Fighting Style',2)
...
Farm:Dropdown("Select Abilities", {
    "Geppo [$10,000 Beli]",
...
Farm:Button("Buy Selected Abilities", function()
...
Farm:Button("Buy Selected Melee", function()
...
Farm:Button("Buy Selected Sword", function()
...
local PVP = Win:CraftTab('PVP')

local Player = PVP:CraftPage('PVP',1)
...
Player:Toggle("Selected Player", false, function(value)
    SpectatePlys = value
...
local Player = PVP:CraftPage('Stats',2)

Player:Toggle("Stats Melee", false, function(value)
    melee = value  
end)

Player:Toggle("Stats Defense", false, function(value)
    defense = value  
end)

Player:Toggle("Stats Sword", false, function(value)
    sword = value  
end)

Player:Toggle("Stats Gun", false, function(value)
    gun = value  
end)

Player:Toggle("Stats Fruit", false, function(value)
    demonfruit = value  
end)
